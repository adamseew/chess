...
public class TestExampleMatch {
	...
	public void TestMatch() {
		...
		Assert.assertEquals(PieceType.KNIGHT,
				chessModel.getPiece(new Point(5, 2)).getPieceType());
		Assert.assertEquals(PieceColor.WHITE,
		...
		Assert.assertEquals(PieceType.BISHOP,
				chessModel.getPiece(new Point(2, 7)).getPieceType());
		Assert.assertEquals(PieceColor.BLACK,
